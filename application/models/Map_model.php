...
//                    $columnArray['in2'] = '';
//                    $columnArray['out2'] = '';
                    $columnArray['latlong1']='';
                    $columnArray['latlong2']='';
                    $columnArray['latlong3']='';
                    $columnArray['latlong4']='';
                    $columnArray['latlong'] = array();
...
//                        $columnArray['anomaly'] = "";
                      ...
                      //latlong each punch 
                      if($columnArray['latlong1'] == 0 && $keyUser['managerID'] == $keyQuery['managerID'] && $keyQuery['attendanceStatus'] == 'in1'){
                      $columnArray['latlong1'] = $keyQuery['latLongIn'];
                      
                      } elseif($columnArray['latlong2'] == 0&& $keyUser['managerID'] == $keyQuery['managerID'] && $keyQuery['attendanceStatus'] == 'out1'){
                      $columnArray['latlong2'] = $keyQuery['latLongIn'];
                      
                      } elseif($columnArray['latlong3'] == 0&& $keyUser['managerID'] == $keyQuery['managerID'] && $keyQuery['attendanceStatus'] == 'in2'){
                      $columnArray['latlong3'] = $keyQuery['latLongIn'];
                      
                      } elseif($columnArray['latlong4'] == 0&& $keyUser['managerID'] == $keyQuery['managerID'] && $keyQuery['attendanceStatus'] == 'out2'){
                      $columnArray['latlong4'] = $keyQuery['latLongIn'];
                      
                      } 
                      
                      $columnArray['latlong'] = [$columnArray['latlong1'],$columnArray['latlong2'],$columnArray['latlong3'],$columnArray['latlong4']];
                     //print_r($keyQuery['latLongIn']);
