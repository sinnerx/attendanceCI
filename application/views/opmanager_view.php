  ...
  <section class="vbox">
    <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
      <div class="navbar-header aside-md dk">
        ...
        <a href="../" class="navbar-brand"><img src="<?php echo base_url();?>images/logo.png" class="m-r-sm"><?php if($userid==1){ echo "Administration Mode";}else{echo $this->opmanager_model->getClusterName($userid);} ?></a>
      ...
      <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <?php echo $this->opmanager_model->getFullName($userid); ?><b class="caret"></b>
          </a>
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="hidden-nav-xs clear">
              <span class="block m-t-xs">
                <strong class="font-bold text-lt"><?php echo $this->opmanager_model->getFullName($userid)?></strong> 
                <b class="caret"></b>
              </span>
              <span class="text-muted text-xs block">
                  <?php if($userLevel==99){ 
                    echo "Administration Mode";
                       ...
                       echo $this->opmanager_model->getClusterName($userid);
                    } ?></span>
            </span>
          </a>
                  ...
                  <section class="row m-b-md">
                    <div class="col-sm-6">
                      ...
                      <!--<div class="well well-sm">All about your profile. You can edit all through here.</div>-->
                       <small>Welcome back,<?php echo $this->opmanager_model->getFullName($userid)?>, <?php echo $this->opmanager_model->getClusterName($userid); ?><!--<i class="fa fa-map-marker fa-lg text-primary"></i>--> </small>
                    </div>
                  </section>
                        ...
                        <div class="panel-heading b-b">
                         <!-- <span class="badge pull-right">12</span>
                          ...
                          <div class="table-responsive">
                              <table id="tableOpmanager" class="table table-striped m-b-none">
