...
//     echo "<li><input type='checkbox' name='files[]' value='".$file_name."' /><a href='".$file_name."'><img src=\"images/attendance/$file_name.\"alt='' height=\"42\" width=\"42\" /></a></li>"; 
//}
//?>
</table>-->
    
<!--<input type="text" name="zone" id="" placeholder=" All Zone">-->
 <select>
...
<!--<input type="text" name="cluster" id="" placeholder=" All Cluster">
